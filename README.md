...
`make submit` можно вызывать неограниченное число раз для любых задач. После успешного `make submit` вы вернётесь на ветку `main` со всеми вашими изменениями, не касающимися сданной задачи, и вы сможете продолжить делать другие задачи на ней.
